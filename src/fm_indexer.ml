...
let save_parse (parse : Parser.parse) (out_prefix : string) =
  StringSerializer.write_list (out_prefix ^ ".dict") parse.phrases;
  Int32Serializer.write_list (out_prefix ^ ".occs") parse.freqs;
  Int32Serializer.write_list (out_prefix ^ ".parse") parse.parse
